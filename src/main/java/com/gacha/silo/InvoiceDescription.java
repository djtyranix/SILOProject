...
public class InvoiceDescription extends javax.swing.JPanel {
     ...
     */
    public InvoiceDescription(MainPage mainPage, Invoice invoice) {
        initComponents();
    ...
    public final void addInvoice(Invoice invoice) {
        this.invoice = invoice;
    }

    public final void fillFormInput() {
        this.InvoiceNumberText.setText(invoice.getId());
        this.PONumberText.setText(invoice.getPoNumber());
        this.SupplierNameText.setText(invoice.getSupplierName());
        this.OrderDateText.setText(invoice.getOrderDate());
        this.DeliveryDateText.setText(invoice.getDeliveryDate());
